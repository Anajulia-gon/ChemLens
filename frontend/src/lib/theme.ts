 ...
 * São os mesmos tons de cinza (+ acentos semânticos) usados no mock, apenas
...
export const colors = {
  ...
  sidebarCollapsed: "#e5e5e5",
  navIdleBg: "#d6d6d6",
  navIdleStroke: "#3a3a3a",

  tableHeaderBg: "#c8cbcf",
  tableRowAlt: "#f6f7f8",
  tableBorder: "#e2e2e2",
  tableDividerRow: "#ededed",
  tableRowHover: "#eef1f4",

  chartAxisText: "#8a8a8a",
  chartGridLine: "#dcdcdc",
  chartBaseline: "#cfcfcf",
  chartBar: "#4c9aff",
  chartBarActive: "#1f5fbf",

  summaryCardBg: "#d9d9d9",

  detailPanelBg: "#e4e4e4",
  detailFooterBg: "#cfcfcf",
  detailUncertaintyLine: "#c4c1bd",
  detailBandBg: "#f6ddda",
  detailBandBorder: "#e6ada5",
  detailMarker: "#c0392b",
  alertCardBg: "#c9c9c9",
} as const;
